...
function Favorite() {
  const dishes = [
    ...
    },
    {
      ...
      formula: `1. Nấu cơm: Vo gạo sạch, nấu cơm với lượng nước vừa đủ để cơm dẻo và dính.;2. Pha giấm trộn cơm: Trộn giấm gạo, đường và muối cho tan. Trộn đều với cơm khi cơm còn nóng.;3. Chuẩn bị hải sản: Cắt hải sản thành miếng vừa ăn.;4. Cuốn sushi: Trải rong biển lên mành tre, cho cơm lên trên, xếp hải sản và rau củ, cuộn chặt lại. Cắt sushi thành từng miếng vừa ăn.;5. Thưởng thức: Dùng kèm wasabi, nước tương và gừng ngâm chua.`,
    },
    {
      id: 3,
        ...
        <View className="p-4">
          ...
          {dishes.map((dish) => (
            ...
            >
              ...
              <Text className="text-lg font-semibold mb-1">{dish.title}</Text>
